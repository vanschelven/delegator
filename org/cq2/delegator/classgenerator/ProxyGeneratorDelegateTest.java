...
public class ProxyGeneratorDelegateTest extends TestCase implements InvocationHandler {
	...
	public void setUp() throws Exception {
		...
		invokeArgs = null;
		proxy =
			(ProxyGeneratorDelegateTestClass) ProxyGenerator.newProxyInstance(
				ClassLoader.getSystemClassLoader(),
				ProxyGeneratorDelegateTestClass.class,
				this);
	}
	...
	public void testGenClass() throws Exception {
		...
		assertNotNull(obj);
		Method objectString =
			obj.getClass().getMethod("objectString", new Class[] { String.class });
	...
	public void testDelegate() throws Exception {
		ProxyGeneratorDelegateTestClass testProxy =
			(ProxyGeneratorDelegateTestClass) ProxyGenerator.newProxyInstance(
				ClassLoader.getSystemClassLoader(),
				ProxyGeneratorDelegateTestClass.class,
				this);
	...
	public void testReturnIntArray() {
		...
		invokeResult = new double[][] { { 1.1, 2.2 }, {
				2.4, 4.5 }
		};
	...
	public void testProtectedMethod() {
		Object testProxy =
			ProxyGenerator.newProxyInstance(MyClass.class.getClassLoader(), MyClass.class, this);
		assertNotNull(testProxy);
	}
