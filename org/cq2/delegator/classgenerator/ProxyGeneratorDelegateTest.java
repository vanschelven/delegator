...
public class ProxyGeneratorDelegateTest extends TestCase {
	...
	public void testGenerateParametersNames() {
	    String[] args = ClassGenerator.generateParameterNames(0);
		assertTrue(Arrays.equals(new String[]{}, args));
		args = ClassGenerator.generateParameterNames(1);
	...
	//TODO iets nieuws verzinnen (als ik dat al wil) om het volgende weer mogelijk te maken
//	public void testDelegate() throws Exception {
//		ProxyGeneratorDelegateTestClass testProxy = (ProxyGeneratorDelegateTestClass) ClassGenerator
//				.newProxyInstance(ProxyGeneratorDelegateTestClass.class, self);
...
//		assertTrue(delegateObj instanceof Self);
//		assertSame(delegateObj, self);
...
//		Object testProxy = ClassGenerator.newProxyInstance(HashMap.class, self);
...
//				new Class[]{MyInterface.class}, new InvocationHandlerWrapper(self));
