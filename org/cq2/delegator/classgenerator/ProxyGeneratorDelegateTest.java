...
public class ProxyGeneratorDelegateTest extends TestCase implements
        InvocationHandler {
    ...
    public void setUp() throws Exception {
        ...
        invokeMethod = null;
        invokeArgs = null;
        proxy = (ProxyGeneratorDelegateTestClass) ProxyGenerator
    ...
    public void testGenClass() throws Exception {
        Object obj = ProxyGenerator.newProxyInstance(ClassLoader
                .getSystemClassLoader(), ProxyGeneratorDelegateTestClass.class,
                this, Delegator.defaultMethodFilter());
        assertNotNull(obj);
        Method objectString = obj.getClass().getMethod("objectString",
    ...
    public void testGenerateParametersNames() throws NoSuchMethodException {
    ...
    public void testReturnIntArray() {
        ...
        assertTrue(Arrays.equals((double[][]) invokeResult, proxy
                .doubleMatrixVoid()));
    }
    ...
    public void testSomeArguments() {
        proxy.voidAllArgTypes("Noot", new Object(), 1, true, 2, 1.2,
                (float) 9.0, (byte) 16, (short) 23, 'K');
    ...
    public void testPassByte() {
        proxy.voidByte((byte) 3);
        assertTrue(Arrays
                .equals(new Object[] { new Byte((byte) 3)}, invokeArgs));
    }

    public void testPassShort() {
        proxy.voidShort((short) 7);
        assertTrue(Arrays.equals(new Object[] { new Short((short) 7)},
                invokeArgs));
    }
    ...
    public void testPassChar() {
        proxy.voidChar('F');
        assertTrue(Arrays
                .equals(new Object[] { new Character('F')}, invokeArgs));
    }
    ...
    public void testProtectedMethod() {
        Object testProxy = ProxyGenerator.newProxyInstance(MyClass.class
                .getClassLoader(), MyClass.class, this, Delegator
                .defaultMethodFilter());
        assertNotNull(testProxy);
    }
    ...
    public void testIf() {
        Object testProxy = Proxy.newProxyInstance(MyClass.class
